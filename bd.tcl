...
# module references:
# dma_s2mm_cmd, fifo2axis, monitor
...
proc create_hier_cell_result_tranfer { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 9 -to 0 data_valid_i
  create_bd_pin -dir I end_flag
  create_bd_pin -dir I result_i
  ...
  connect_bd_net -net Net [get_bd_pins clear] [get_bd_pins monitor_0/clear]
  ...
  connect_bd_net -net clk_0_1 [get_bd_pins clk] [get_bd_pins axi_datamover_0/m_axi_s2mm_aclk] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_awclk] [get_bd_pins dma_s2mm_cmd_0/clk] [get_bd_pins fifo2axis_0/clk] [get_bd_pins fifo_generator_0/clk] [get_bd_pins ila_0/clk] [get_bd_pins monitor_0/clk]
  connect_bd_net -net data_valid_i_0_1 [get_bd_pins data_valid_i] [get_bd_pins monitor_0/data_valid_i]
  ...
  connect_bd_net -net end_flag_0_1 [get_bd_pins end_flag] [get_bd_pins dma_s2mm_cmd_0/end_flag] [get_bd_pins ila_0/probe7]
  connect_bd_net -net fifo2axis_0_rd_en [get_bd_pins fifo2axis_0/rd_en] [get_bd_pins fifo_generator_0/rd_en] [get_bd_pins monitor_0/rd_en]
  ...
  connect_bd_net -net monitor_0_count_1 [get_bd_pins ila_0/probe0] [get_bd_pins monitor_0/count_1]
  connect_bd_net -net monitor_0_count_2 [get_bd_pins ila_0/probe1] [get_bd_pins monitor_0/count_2]
  connect_bd_net -net monitor_0_count_3 [get_bd_pins ila_0/probe2] [get_bd_pins monitor_0/count_3]
  connect_bd_net -net monitor_0_count_4 [get_bd_pins ila_0/probe3] [get_bd_pins monitor_0/count_4]
  connect_bd_net -net monitor_0_count_5 [get_bd_pins ila_0/probe4] [get_bd_pins monitor_0/count_5]
  connect_bd_net -net monitor_0_result_cnt1 [get_bd_pins ila_0/probe5] [get_bd_pins monitor_0/result_cnt1]
  connect_bd_net -net monitor_0_result_cnt2 [get_bd_pins ila_0/probe6] [get_bd_pins monitor_0/result_cnt2]
  connect_bd_net -net result_i_0_1 [get_bd_pins result_i] [get_bd_pins monitor_0/result_i]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axi_datamover_0/m_axi_s2mm_aresetn] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_aresetn] [get_bd_pins dma_s2mm_cmd_0/rst_n] [get_bd_pins fifo2axis_0/rst_n] [get_bd_pins monitor_0/rst_n] [get_bd_pins util_vector_logic_0/Op1]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_DOUT_DEFAULT {0x01000000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__IOU_SWITCH_CTRL__ACT_FREQMHZ {263.330719} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {188.093369} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {7} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {200} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {329.163391} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR0 {4} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__FREQMHZ {333.3} \
   ...
   CONFIG.PSU__CRL_APB__RPLL_CTRL__FBDIV {79} \
  ...
  connect_bd_net -net Frame_Arbiter_0_data_valid_n [get_bd_pins Frame_Arbiter_0/data_valid_n] [get_bd_pins lsp_debug_0/data_valid_i] [get_bd_pins result_tranfer/data_valid_i]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins result_tranfer/clear]
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net light_spot_positioni_0_end_flag [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins lsp_debug_0/end_flag] [get_bd_pins result_tranfer/end_flag]
  ...
  connect_bd_net -net lsp_debug_0_data_valid_o [get_bd_pins lsp_debug_0/data_valid_o] [get_bd_pins result_tranfer/FIFO_WRITE_wr_en] [get_bd_pins result_tranfer/result_i]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_mcdma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_mcdma_0/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces result_tranfer/axi_datamover_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
